...
abstract final class AppTypography {
  ...
  static TextTheme get textTheme => const TextTheme(
        ...
        displayLarge: TextStyle(
          fontFamily: _family, fontSize: 40, fontWeight: FontWeight.w900,
          height: 1.15,
        ),
        displayMedium: TextStyle(
          fontFamily: _family, fontSize: 32, fontWeight: FontWeight.w800,
          height: 1.15,
        ),
        ...
        bodyMedium: TextStyle(
          fontFamily: _family, fontSize: 15, fontWeight: FontWeight.w500,
          height: 1.55,
        ),
        bodySmall: TextStyle(
        ...
        labelSmall: TextStyle(
          fontFamily: _family, fontSize: 11, fontWeight: FontWeight.w600,
          height: 1.3,
        ),
      );
}
